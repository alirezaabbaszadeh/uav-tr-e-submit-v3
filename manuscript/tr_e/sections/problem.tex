...
Figure~\ref{fig:conceptual_discretization} provides a conceptual view of the modeling pipeline: a continuous physical environment and link abstraction are mapped into a discrete weighted graph whose arc weights combine energy and outage-risk proxies. This is the key engineering step that enables fleet-scale routing and conservative, auditable benchmarking.
\begin{figure}[t]
\centering
\includegraphics[width=0.95\linewidth]{generated/figures/fig_conceptual_discretization.pdf}
\caption{Conceptual abstraction from continuous environment to a discrete weighted routing graph (energy + outage risk).}
\label{fig:conceptual_discretization}
\end{figure}
